...
function iniciarCanvas() {
	...
	function iniciar() {
		...
		contenedores = [
			{
				nombre: 'A',
				src: '../../public/assets/modulos/mod9/img/frase/marco.png',
				largo: 200,
				alto: 200,
				img: null,
				posX: 0,
		...
		objetos = [
			{
				nombre: 'primera',
				src: '../../public/assets/modulos/mod9/img/frase/metacognicion(1).png',
				largo: 180,
				alto: 180,
				img: null,
				posX: 210,
			...
			{
				nombre: 'tercera',
				src: '../../public/assets/modulos/mod9/img/frase/defEstrategias.png',
				largo: 180,
				alto: 180,
				img: null,
				posX: 0,
			...
			{
				nombre: 'segunda',
				src: '../../public/assets/modulos/mod9/img/frase/defFormas.png',
				largo: 180,
				alto: 180,
				img: null,
				posX: 420,
		...
		if (comple) {
			if (puntos == 3) {
				...
				swal({
					type: 'error',
					title: 'Oops...',
					text: 'Recuerda que la METACOGNICIÓN es el conocimiento sobre el conocimiento. ' +
					'Las estrategias son los pasos que nos permiten hacer METACOGNICIÓN y las Formas ' +
