function opc1() {
    swal.mixin({
        ...
        progressSteps: ['1', '2', '3', '4', '5']
            ...
            text: 'Según La UNESCO [1] Este Curriculum sobre alfabetización mediática e informacional (AMI) debería ser visto dentro del amplio ' +
        ...
        },
        {
            text: 'Los profesores y estudiantes, consciente o inconscientemente, aplican los elementos de un proceso de ' +
                ...
                '(radio, televisión, periódicos y bibliotecas) al aula. [1] '
        },
        {
