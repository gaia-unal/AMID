function opc1() {
    swal.mixin({
    ...
    }).queue([
        {
            ...
            'características tales como raza, género, sexualidad, edad o clase.'
        },
        {
            text: 'Inevitablemente, aquellos que trabajan en los medios deben seleccionar el contenido que se va a presentar al público.'+
            ...
            'presentar una discusión e información sin control de ningún partido o gobierno. '
        },
        {
            text: 'También tenemos que entender que los medios y otros proveedores de información trabajan en un'+
            ...
            'que exigimos y aceptamos. '
        },
        {
            text: 'Muchas industrias mediáticas en varias regiones han desarrollado'+
