function opc1() {
    swal.mixin({
        ...
        progressSteps: ['1', '2', '3', '4', '5', '6', '7']
            ...
            text: 'Según la UNESCO [1] El objetivo de este módulo es enseñar que hay otras habilidades importantes de información y ' +
        ...
        },
        {
            text: 'Este módulo enfatiza los bloques de construcción que contribuyen a la alfabetización informacional. ' +
                ...
                'subraya la importancia de que los usuarios sean aprendices entrenados. [1]'
        },
        {
            text: 'Los profesores tienen que adquirir por sí mismos y desarrollar en sus estudiantes un conjunto ' +
                ...
                'almacenar, y presentar la información para el análisis de problemas y la toma de decisiones. [1]'
        },
        {
        ...
        },
        {
            text: 'Trata de habilitar a los profesores para que comprendan los conceptos de información, ' +
                ...
                'profesores tengan una participación continua en una vida intelectual activa. [1]'
        }
    ]);
}