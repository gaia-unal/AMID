function opc1() {
    swal.mixin({
    ...
    }).queue([
        {
            ...
            'defensa para la democracia y las libertades de las que gozamos, podrían no sobrevivir. '
        },
        {
            text: 'Es importante que los medios atraigan los ingresos de la publicidad al ofrecer oportunidades o'+
        ...
        {
            text: 'Dado el importante papel que tiene la publicidad en nuestras sociedades en la actualidad,'+
            ...
            'grupos de consumidores por si tienen preguntas o preocupaciones sobre las prácticas de la industria. '
        },
        {
            text: 'La publicidad en el presente ha ido más allá de su papel tradicional. Ya no sólo'+
