...
function iniciarCanvas() {
    ...
    function iniciar() {
        ...
        contenedores = [
            {
                nombre: 'ContenedorA',
                src: '../../public/assets/modulos/mod7/img/marco.png',
                largo: 250,
                alto: 70,
                img: null,
                posX: 0,
        ...
        objetos = [
            {
                nombre: 'quinta',
                src: '../../public/assets/modulos/mod7/img/2frase/5.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 10,
            ...
            {
                nombre: 'novena',
                src: '../../public/assets/modulos/mod7/img/2frase/9.png',
                largo: 220,
                alto: 38,
                img: null,
                posX: 244,
            ...
            {
                nombre: 'primera',
                src: '../../public/assets/modulos/mod7/img/2frase/1.png',
                largo: 220,
                alto: 38,
                img: null,
                posX: 470,
            ...
            {
                nombre: 'cuarta',
                src: '../../public/assets/modulos/mod7/img/2frase/4.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 10,
            ...
            {
                nombre: 'octava',
                src: '../../public/assets/modulos/mod7/img/2frase/8.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 240,
            ...
            {
                nombre: 'segunda',
                src: '../../public/assets/modulos/mod7/img/2frase/2.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 470,
            ...
            {
                nombre: 'sexta',
                src: '../../public/assets/modulos/mod7/img/2frase/6.png',
                largo: 220,
                alto: 40,
                img: null,
                posX: 10,
            ...
            {
                nombre: 'tercera',
                src: '../../public/assets/modulos/mod7/img/2frase/3.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 240,
            ...
            {
                nombre: 'septima',
                src: '../../public/assets/modulos/mod7/img/2frase/7.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 470,
        ...
        if (comple) {
            if (puntos == 9) {
                ...
                swal({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'La frase correcta es: Red informática de nivel mundial que sirve para transmitir y buscar cualquier tipo de información que necesite, comunicación y entretenimiento'
                });
                iniciarCanvas();
            }
        }
