...
function iniciarCanvas() {
    ...
    function iniciar() {
        ...
        contenedores = [
            {
                nombre: 'ContenedorA',
                src: '../../public/assets/modulos/mod7/img/actividades/marco.png',
                largo: 250,
                alto: 70,
                img: null,
                posX: 0,
        ...
        objetos = [
            {
                nombre: 'uno',
                src: '../../public/assets/modulos/mod7/img/actividades/1.png',
                largo: 150,
                alto: 49,
                img: null,
                posX: 10,
            ...
            {
                nombre: 'cinco',
                src: '../../public/assets/modulos/mod7/img/actividades/5.png',
                largo: 220,
                alto: 50,
                img: null,
                posX: 180,
            ...
            {
                nombre: 'tres',
                src: '../../public/assets/modulos/mod7/img/actividades/3.png',
                largo: 150,
                alto: 43,
                img: null,
                posX: 420,
            ...
            {
                nombre: 'cuatro',
                src: '../../public/assets/modulos/mod7/img/actividades/4.png',
                largo: 130,
                alto: 50,
                img: null,
                posX: 580,
            ...
            {
                nombre: 'dos',
                src: '../../public/assets/modulos/mod7/img/actividades/2.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 20,
            ...
            {
                nombre: 'seis',
                src: '../../public/assets/modulos/mod7/img/actividades/6.png',
                largo: 220,
                alto: 49,
                img: null,
                posX: 270,
        ...
        if (comple) {
            if (puntos == 6) {
                ...
                swal({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'El orden correcto es: 1. Trabajos del colegio, 2. Escuchar o descargar musica, 3. Usar redes sociales, 4. Jugar, 5. Ver o descargar películas y videos, 6. Pasar tiempo en un mundo virtual'
                });
                iniciarCanvas();
            }
        }
