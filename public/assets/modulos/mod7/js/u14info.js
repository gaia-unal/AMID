function preg1() {
    swal.mixin({
        ...
        {
            imageUrl: '../../public/assets/modulos/mod7/img/tolerancia.png'
        }
    ]);
}
...
function preg2() {
    swal.mixin({
        ...
        {
            imageUrl: '../../public/assets/modulos/mod7/img/perdidaControl.png'
        }
    ]);
}
...
function preg5() {
    swal.mixin({
        ...
        {
            imageUrl: '../../public/assets/modulos/mod7/img/cambiosComportamiento.png'
        }
    ]);
}
...
function preg6() {
    swal.mixin({
        ...
        {
            imageUrl: '../../public/assets/modulos/mod7/img/sindromeAbstinencia.png'
        }
    ]);
}