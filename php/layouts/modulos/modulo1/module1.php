...
<body>
  <?php require_once "../../../queries/connectionDB.php";
    ...
    include '../../../queries/estadoMod.php'; estadoMod(1,1);
  ?>
    ...
    <div class="row">
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="#" class="list-group-item active">Módulo 1</a>
      ...
      <!-- /.col-lg-3 -->
      <div class="col-lg-9">
        <h1><br> Módulo 1: Ciudadanía, libertad de expresión e información, acceso a la información, discurso
          democrático y aprendizaje a lo largo de la vida</h1>
        <div class="card mt-4">
          <div class="card-body">
        ...
        <br>
        <center>
          <a href="../../inicio.php" class="btn btn-success">Anterior</a>
          <a href="modulo1.1/module1.1_inicio.php" class="btn btn-success">Siguiente</a>
        </center>
        <?php 
