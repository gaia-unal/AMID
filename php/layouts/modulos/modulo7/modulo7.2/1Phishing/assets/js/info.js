function preg1() {
    swal.mixin({
        ...
        {
            html: '“Se conoce como <strong>‘phishing’</strong> (del inglés fishing, pescar) a la suplantación ' +
                ...
                'ajenos” (Gudín Rodríguez - Magariños, 2016) < br > <em>Phishing</em> se refiere al proceso de ' +
        ...
        {
            text: 'Los delincuentes obtienen información como número de tarjetas de crédito, contraseñas, ' +
                'información de cuentas u otros datos personales por medio de engaños. Este delito sucede la ' +
                'mayoría de las veces a través de mensajes de correo electrónico.'
        }
    ]);
}
...
function preg2() {
    swal.mixin({
        ...
        {
            text: 'Este tipo de ataque es el más sencillo a la hora de analizarlo técnicamente; normalmente ' +
        ...
        },
        {
            text: 'La principal característica del phishing tradicional es que está ligado a un solo sitio web ' +
                'en el cual se alojan todos los contenidos del portal falso. (Paus, 2015)'
        },
        {
        ...
        {
            imageUrl: 'assets/img/Paypal-tradicional.png'
        }
    ]);
}
...
function preg2() {
    swal({
        ...
        confirmButtonText: 'Siguiente &rarr;',
        backdrop: 'rgb(240, 255, 255)',
        html: 'Esta clase de <em>phishing</em> está dirigido a personas o grupos reducidos. De esta manera ' +
            ...
            'conocidas para generar una mayor empatía y confianza. (Paus, 2015)'
    });
}
...
function preg4() {
    swal({
        ...
        {
            html: 'Esta técnica de <em>phishing</em> se relaciona con el uso de teléfonos celulares.<br> ' +
        ...
        {
            imageUrl: 'assets/img/smishing.png'
        }
    ]);
}
...
function preg5() {
    swal({
        ...
        confirmButtonText: 'Siguiente &rarr;',
        backdrop: 'rgb(240, 255, 255)',
        html: 'Se basa en la instauración de falsos centros de atención telefónica que realizan llamadas ' +
