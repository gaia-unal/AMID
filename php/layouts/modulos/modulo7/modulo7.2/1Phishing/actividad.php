            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <br>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia1.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia2.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia3.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia4.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia5.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia6.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia7.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia8.png">
                        </div>
                        <div>
                            <img class="img" id="imagen" src="assets/img/bancolombia9.png">
                        </div>
                    </div>
                </div>
                <!-- /.card -->
                ...
                <center>
                    ...
                    <a href="test.php" class="btn btn-success btnSig retraso3">Siguiente</a>
