            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div>
                            <center>
                                <img class="bounceIn animated" id="web" src="assets/img/web.png" alt="web">
                        ...
                        <p class="card-text">
                            ...
                            <div class="img"><a href="assets/img/diferencias.png" target="_blank"> <img id="diferencias"
                                        src="assets/img/diferencias.png" alt="diferencias"></a></div>
                            <center>
                ...
                <br>
                <center>
                    <a href="../Internet/actividad3.php" class="btn btn-success">Anterior</a>
