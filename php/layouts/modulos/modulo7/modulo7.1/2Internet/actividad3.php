            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="p1">
                            <h4>1. ¿Qué relación tiene el derecho de la libre expresión con el derecho a la información
                                y la protección de los datos?</h4>
                            <textarea name="preg1" id="p1-r" cols="90" rows="10" placeholder="..."></textarea>
                        </div>
                        <div class="p2">
                            <h4>2. ¿Deberían los niños y niñas tener igual acceso a la información, internet y nuevas
                                tecnologías?</h4>
                            <textarea name="preg2" id="p2-r" cols="90" rows="10" placeholder="..."></textarea>
                        </div>
                        <div class="p3">
                            <h4>3. ¿Qué modelo de conducta propondría para niños y jóvenes con acceso a internet?</h4>
                ...
                <br>
                <center>
                    <a href="actividad2.php" class="btn btn-success">Anterior</a>
                    <a href="../3Web/index.php" class="btn btn-success btnSig retraso3">Siguiente</a>
...
<!-- Bootstrap core JavaScript -->
    ...
    <script src="assets/js/preg2.js"></script>
</body>
