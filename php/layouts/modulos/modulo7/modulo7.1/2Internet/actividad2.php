    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    <ul class="list-group-item">
                        ...
                        <a href="#" onclick="inactive(1)" class="list-group-item inactive">Unidad 2</a>
                    </ul>
            ...
            <div class="col-lg-9">
                ...
                <br>
                <center>
                    <a href="actividad1.php" class="btn btn-success">Anterior</a>
                    <a href="actividad3.php" class="btn btn-success btnSig retraso3">Siguiente</a>
