    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <br>
                <center>
                    <a href="../modulo7/modulo7.2/mod7.2_inicio.php" class="btn btn-success">Anterior</a>
                    <a href="modulo8.1/module8.1_inicio.php" class="btn btn-success btnSig retraso3">Siguiente</a>
