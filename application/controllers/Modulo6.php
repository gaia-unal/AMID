...
class Modulo6 extends CI_Controller {
	...
	public function unidad1(){
		...
		if(isset($this->id)){
			...
			$submit=$this->input->post('submit');
			if(!$seg['seg3']){
				$this->load->view('modulos/modulo6/unidad1/inicio',$data);
			}
			...
			if($seg['seg3']){
				...
				$data['profesormodulo']=$this->profesormoduloModel->getOne();
				$this->load->view("modulos/modulo6/unidad1/".$seg['seg3'],$data);
			}
	...
	public function unidad2(){
		...
		if(isset($this->id)){
			...
			if(!$seg['seg3'] && !isset($submit)){
				$this->load->view('modulos/modulo6/unidad2/inicio',$data);
			}
			else if($seg['seg4'] && isset($submit)){
			...
			if($seg['seg3']){
				...
				$this->session->unset_userdata('idAct');
				$data['profesormodulo']=$this->profesormoduloModel->getOne();
				$this->load->view("modulos/modulo6/unidad2/".$seg['seg3'],$data);
			}
	...
	public function unidad3(){
		...
		if(isset($this->id)){
			...
			$submit=$this->input->post('submit');
			if(!$seg['seg3'] && !isset($submit)){
				$this->load->view('modulos/modulo6/unidad3/inicio',$data);
			}
			else if($seg['seg4'] && isset($submit)){
			...
			if($seg['seg3']){
				...
				$this->session->unset_userdata('idAct');
				$data['profesormodulo']=$this->profesormoduloModel->getOne();
				$this->load->view("modulos/modulo6/unidad3/".$seg['seg3'],$data);
			}
