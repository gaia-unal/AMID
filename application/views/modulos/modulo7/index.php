        ...
        <div id="page-content-wrapper">
            ...
            <nav class="bread-style" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Módulo 7</li>
                </ol>
            </nav>
            ...
            <center>
                <a href="<?php echo base_url();?>modulo6/unidad3/evaluacion" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo7/unidad1" class="btn btn_navegacion">Siguiente</a>
            </center>
            <br>
