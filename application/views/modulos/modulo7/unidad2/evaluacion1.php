                    ...
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                ...
                                <a href="<?php echo base_url(); ?>modulo7/unidad2/evaluacion" class="list-group-item">Evaluación</a>
                            </ul>
                        </div>
                    </div>
                </ul>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <center>
                    ...
                    <?php 
                    $this->session->set_userdata('idAct','m7u21'); 
        $this->session->set_userdata('ruta','modulo7/unidad2/evaluacion1');
        $var = $this->session->userdata('objeto')['controller']->consulta();
        if(!$var){
            echo form_open('modulo7/unidad2/evaluacion2');
?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <label class="container" id="p4-r2">
                                <input type="radio" name="preg4" id="opc2" value = 5>
                            ...
                            <label class="container" id="p6-r1">
                                <input type="radio" name="preg6" id="opc1" value = 5>
                            ...
                            <label class="container" id="p6-r2">
                                <input type="radio" name="preg6" id="opc2" value = 1>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo7/unidad2/actividad6" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo7/unidad2/evaluacion2" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
