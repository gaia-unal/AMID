    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <br>
                <center>
                    <a href="<?php echo base_url();?>modulo7/unidad2/actividad5" class="btn btn-success">Anterior</a>
                    <a href="<?php echo base_url();?>modulo7/unidad2/evaluacion1" class="btn btn-success">Siguiente</a>
                </center>
