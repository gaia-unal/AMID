        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <center>
                    ...
                    <?php 
                    $this->session->set_userdata('idAct','m7u22'); 
        $this->session->set_userdata('ruta','modulo7/unidad2/evaluacion2');
        $var = $this->session->userdata('objeto')['controller']->consulta();
        if(!$var){
            echo form_open('modulo8');
?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <input type="text" name="preg" value= 1 id="preg" style="display: none">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo7/unidad2/evaluacion1" class="btn btn_navegacion">Anterior</a>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo7/unidad2/evaluacion1" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo8" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
