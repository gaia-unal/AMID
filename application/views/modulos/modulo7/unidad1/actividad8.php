        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <center>
                    ...
                    <?php echo form_open('modulo7/unidad1/actividad9');$this->session->set_userdata('idAct','m7u1a8'); $this->session->set_userdata('ruta','modulo7/unidad1/actividad8');?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
                        <br>
                        ...
                        <div class="p1">
                            <h4 class="subtEv">¿Qué es la Web?</h4>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo7/unidad1/actividad7" class="btn btn_navegacion">Anterior</a>
