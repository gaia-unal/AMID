...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <?php $this->session->set_userdata('ruta','modulo7/unidad1/actividad4'); ?>
                <div class="card mt-4">
                    <div class="card-body">
                        <br>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo7/unidad1/actividad3" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo7/unidad1/actividad5" class="btn btn_navegacion btnSig Retraso5">Siguiente</a>
            </center>
    ...
    <script src="<?php echo base_url();?>public/assets/modulos/mod7/js/u12preg1.js"></script>
