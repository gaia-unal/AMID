...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <?php $this->session->set_userdata('ruta','modulo7/unidad1/actividad5'); ?>
                <div class="card mt-4">
                    <div class="card-body">
                        <br>
                        <h4 class="subtitle">En los marcos, ubica en orden de mayor a menor las actividades de acuerdo
                            al nivel de uso</h4><br>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo7/unidad1/actividad4" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo7/unidad1/actividad6"
    ...
    <script src="<?php echo base_url();?>public/assets/modulos/mod7/js/u12preg2.js"></script>
