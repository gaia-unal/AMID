    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <br>
                <?php  $this->session->set_userdata('ruta','modulo12/unidad1/contenidos'); ?>
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>
                                Contenidos unidad 1. El nacimiento de medios alternativos
                            </h1>
                            <br>
                            <p class="m-b-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo12/unidad1/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 1: Libertad de expresión
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo12/unidad1/actividad2" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 2: Libertad de expresión
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo12/" class="btn btn_navegacion">Anterior</a>
