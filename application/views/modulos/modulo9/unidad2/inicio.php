...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo9/unidad1/evaluacion" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo9/unidad2/temas" class="btn btn_navegacion">Siguiente</a>
            </center>
