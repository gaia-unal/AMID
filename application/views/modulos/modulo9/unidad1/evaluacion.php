        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <center>
                    ...
                    <?php 
                    $this->session->set_userdata('idAct','m9u1');
             $this->session->set_userdata('ruta','modulo9/unidad1/evaluacion');
             $var = $this->session->userdata('objeto')['controller']->consulta();
             if(!$var){
                 echo form_open('modulo9/unidad2/inicio');
?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
        ...
        <center>
            <a href="<?php echo base_url();?>modulo9/unidad1/actividad2" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo9/unidad2" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
