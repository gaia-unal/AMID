...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>
                                Contenidos unidad 1. Comunicación, enseñanza y aprendizaje
                            </h1>
                            <br>
                            <p class="m-b-10">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo9/unidad1/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Comunicación
                                    </a><br><br>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo9/unidad1/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 1: Reflexión Comunicación, enseñanza y aprendizaje
                                    </a><br><br>
                                </div>
                            </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo9/unidad1/inicio" class="btn btn_navegacion">Anterior</a>
