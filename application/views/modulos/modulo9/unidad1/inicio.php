        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <center>
                    ...
                    <?php $this->session->set_userdata('ruta','modulo9/unidad1'); ?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <ul>
                            ...
                            <li class="animated lightSpeedIn retraso3">Identificar y analizar las teorías básicas de la
                                comunicación y su relación con el
                                proceso de enseñanza-aprendizaje relacionado con la aplicación de las destrezas AMI</li>
                        </ul>
                        </p>
                        </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo9" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo9/unidad1/contenidos" class="btn btn_navegacion">Siguiente</a>
            </center>
