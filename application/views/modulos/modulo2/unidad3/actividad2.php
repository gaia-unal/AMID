        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        echo form_open('modulo2/unidad3/actividad3');
                        $this->session->set_userdata('idAct','m2u3a2'); 
                        $this->session->set_userdata('ruta','modulo2/unidad3/actividad2');
                    ?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
                        <br>
                        <h4 class="subtitle">Refuerzo</h4>
                        <div class="contenido">
                            <p class="card-text">
