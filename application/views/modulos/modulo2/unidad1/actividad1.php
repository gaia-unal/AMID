...
<body>
    ...
    <div class="d-flex" id="wrapper">
                ...
                <ul class="list-group-item">
                    ...
                    <a href="<?php echo base_url();?>modulo2/unidad1" class="list-group-item list-group-item-action bg-light">Unidad 1</a>
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url();?>modulo2/unidad1/actividad1" class="list-group-item">Actividades</a>
        ...
        <div id="page-content-wrapper">
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo2/unidad1" class="btn btn_navegacion">Anterior</a>
