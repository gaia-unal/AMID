                ...
                <ul class="list-group-item">
                    ...
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url(); ?>modulo2/unidad4/contenidos" class="list-group-item">Contenidos</a>
                                <a class="list-group-item">Evaluación</a>
                            </ul>
                        </div>
                    </div>
                </ul>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>Contenidos unidad 4. El proceso de desarrollo de las noticias: más allá de 5 por qués y 1 cómo (5ws y 1h en inglés)
                            </h1>
                            <br>
                            <p class="m-b-10">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo2/unidad4/actividad1" type="button" class="btn btn-info" style="width: 100%;">El proceso de desarrollo de las noticias: más allá de 5 por qués y 1 cómo (5ws y 1h en inglés)
                                    </a> <br><br>
                                </div>
                                <div class="col-6">
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo2/unidad4/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo2/unidad4/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
