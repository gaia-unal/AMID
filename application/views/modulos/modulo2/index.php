        ...
        <div id="page-content-wrapper">
            ...
            <nav class="bread-style" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Módulo 2</li>
                </ol>
            </nav>
                ...
                <div class="card mt-4 contenido">
                    <div class="card-body"><br>
                        ...
                        <p class="card-text"><br>
                            ...
                            <p>[1] UNAOC, UNESCO, "Módulo 2: Entendiendo las noticias, los medios y la ética de información", en 
                                <em>Media Information Literacy for Teachers</em>, 2020.
                                <a href="http://unesco.mil-for-teachers.unaoc.org/modules/modulo-2-entendiendo-las-noticias-los-medios-y-la-etica-de-informacion/?lang=es" target="_blank" rel="noopener noreferrer">
                                http://unesco.mil-for-teachers.unaoc.org/modules/modulo-2-entendiendo-las-noticias-los-medios-y-la-etica-de-informacion/?lang=es</a>
                            </p>
                        </p>
                    </div>
                </div>
            ...
            <center>
                <a href="<?php echo base_url();?>modulo1/unidad4/evaluacion" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo2/unidad1" class="btn btn_navegacion">Siguiente</a>
            </center>
            <br>
