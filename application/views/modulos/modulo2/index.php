    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <br>
                <center>
                    <a href="<?php echo base_url();?>modulo1/unidad4/evaluacion" class="btn btn-success">Anterior</a>
                    <a href="<?php echo base_url();?>modulo2/unidad1" class="btn btn-success">Siguiente</a>
                </center>
