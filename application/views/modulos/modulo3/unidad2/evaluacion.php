...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m3u2'); 
                        $this->session->set_userdata('ruta','modulo3/unidad2/evaluacion');
                        $var = $this->session->userdata('objeto')['controller']->consulta();
                        if(!$var){
                            echo form_open('modulo3/unidad3/inicio');
                            ?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                <label><input type="radio" name="pre1" class="space"  value = 1>Únicamente en la conducta de las 
                                    personas.</label> <br />
                                <label><input type="radio" name="pre1" class="space"  value = 1>Animal y humana.</label><br />
                                <label><input type="radio" name="pre1" class="space"  value = 5>Empresarial, institucional, en 
                                    profesiones como la Medicina, Sistemas informáticos, Auditorías.</label><br /><br>
                                <strong>¿Quién regula en primera instancia el ejercicio ético en un periodista?</strong><br /><br />
                                <label><input type="radio" name="pre2" class="space"  value = 1>La ley es la encargada de observar 
                                    la conducta del periodista.</label><br />
                                <label><input type="radio" name="pre2" class="space"  value = 5>La conciencia personal del 
                                    periodista.</label><br />
                                <label><input type="radio" name="pre2" class="space"  value = 1>Los encargados de administrar los 
                                    manuales de estilos.</label><br /><br>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo3/unidad2/actividad1" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo3/unidad3" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
