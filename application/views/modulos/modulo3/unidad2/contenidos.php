        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>Contenidos unidad 2. Códigos de la industria sobre la diversidad y la representación</h1>
                            <br>
                            <p class="m-b-10">
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo3/unidad2/inicio" class="btn btn_navegacion">Anterior</a>
