    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <a href="<?php echo base_url();?>modulo1" class="list-group-item">Módulo 1</a>
                    ...
                    <ul class="list-group-item">
                        ...
                        <a href="#" onclick="inacitvo(2)" class="list-group-item inactive">Unidad 3</a>
                        <a href="#" onclick="inacitvo(2)" class="list-group-item inactive">Unidad 4</a>
                        <a href="#" onclick="inacitvo(2)" class="list-group-item inactive">Unidad 5</a>
                    </ul>
            ...
            <div class="col-lg-9">
                ...
                <br>
                <center>
                    <a href="<?php echo base_url();?>modulo3/unidad2" class="btn btn-success">Anterior</a>
                    <a href="<?php echo base_url();?>modulo3/unidad2/actividad1" class="btn btn-success">Siguiente</a>
                </center>
