        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        echo form_open('modulo3/unidad2/evaluacion');$this->session->set_userdata('idAct','m3u2a1'); $this->session->set_userdata('ruta','modulo3/unidad2/actividad1'); ?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                el proceso de informar: empresarios, directores, editores y reporteros. <br>
                            ...
                            <blockquote align="justify">
                                ...
                                decisión libre de cada persona. <br>
                            ...
                            <p class="card-text">
                                ...
                                <textarea name="preg1" style="width: 90%;" rows="5" minlength="1" maxlength="500" 
                                onkeypress="return check(event)" placeholder="Escriba su respuesta aquí" spellcheck="true" ></textarea> <br><br>
                                ...
                                <textarea name="preg2" style="width: 90%;" rows="5" minlength="1" maxlength="500" o
                                nkeypress="return check(event)" placeholder="Escriba su respuesta aquí" spellcheck="true" ></textarea>
                            </p>
                            <h4 class="subtitle">Bibliografía:</h4>
                            <p>[1] Laguna Agudelo, L. A., "¿Existen normas que regulan el ejercicio ético del periodismo?", en 
