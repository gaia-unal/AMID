                ...
                <ul class="list-group-item">
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url();?>modulo3/unidad1/actividad1" class="list-group-item">Actividades</a>
...
¿                   <a href="<?php echo base_url();?>modulo3/unidad2" class="list-group-item">Unidad 2</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <p>La UNESCO [1] menciona en su metodología AMID para la unidad 1 del módulo 3 un conjunto 
                        ...
                        <div class="contenido">
                            <ul>
                                ...
                                <li>Comprender la alfabetización mediática e informacional, su importancia y relevancia en
                                    las vidas de los estudiantes y los profesores en la actualidad. </li>
                        ...
                        <div class="contenido">
                            <ul>
                                <li>Definir “información” y “medios”. </li>
                                <li>Explorar la importancia de los medios y otros proveedores de información. </li>
                                <li>Describir los principales resultados de la alfabetización mediática e informacional.
                                </li>
                            </ul>
                        </div>
                        <h4 class="subtitle">Bibliografía:</h4>
                        <p>[1] UNAOC, UNESCO, "Unidad 1: Informes de noticias y el poder de las imágenes", en 
