    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-light border-right" id="sidebar-wrapper">
            <div class="list-group list-group-flush">
                ...
                <ul class="list-group-item">
                    ...
                    <a href="<?php echo base_url();?>modulo3/unidad2" class="list-group-item inactive">Unidad 2</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <br>
                <?php $this->session->set_userdata('ruta','modulo3/unidad1/contenidos'); ?>
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>Contenidos unidad 1. Informes de noticias y el poder de las imágenes</h1>
                            <br>
                            <p class="m-b-10">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo3/unidad1/actividad1" type="button" class="btn btn-info" style="width: 100%;">Representación en los medios de información</a> <br><br>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo3/unidad1/actividad2" type="button" class="btn btn-info" style="width: 100%;">Actividad: Informes de noticias y el poder de las imágenes  </a><br><br>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo3/unidad1/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo3/unidad1/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
