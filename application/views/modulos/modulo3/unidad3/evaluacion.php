...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m3u3a2'); 
                        $this->session->set_userdata('ruta','modulo3/unidad3/evaluacion');
                        $var = $this->session->userdata('objeto')['controller']->consulta();
                        if(!$var){
                            echo form_open('modulo3/unidad4/inicio');
                            ?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                <ul>
                                    ...
                                    <br><li>Realice un análisis sobre las organizaciones de filmación nacionales y las compañías
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo3/unidad3/actividad1" class="btn btn_navegacion">Anterior</a>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo3/unidad3/actividad1" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo3/unidad4" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
