        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>Contenidos unidad 3. Televisión, películas y publicación de libros</h1>
                            <br>
                            <p class="m-b-10">
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo3/unidad3/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo3/unidad3/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
