...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                Marshall Blonsky citado en [1] menciona que:
                                <blockquote>
                                    ...
                                    pedazos de la realidad para lograr cualquier efecto.
                                </blockquote>
                                Por otra parte, 
                                <blockquote>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo3/unidad5" class="btn btn_navegacion">Anterior</a>
