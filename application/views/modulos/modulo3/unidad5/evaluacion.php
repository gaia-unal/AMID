...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m3u5'); 
                        $this->session->set_userdata('ruta','modulo3/unidad5/evaluacion');
                        $var = $this->session->userdata('objeto')['controller']->consulta();
                        if(!$var){
                            echo form_open('modulo4');
                    ?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                            ...
                            <p class="card-text">
                                <ul>
                                    <li><strong> ¿Qué es el fotoperiodismo?</strong></li><br>
                                        <label><input type="radio" name="pre1" class="space"  value = 1>Tomar fotos y publicarlas en un periódico.</label> <br />
                                        <label><input type="radio" name="pre1" class="space"  value = 1>Es leer el periódico a través de fotografías</label><br />
                                        <label><input type="radio" name="pre1" class="space"  value = 5>Es un género del periodismo que tiene que ver directamente con la fotografía, el diseño gráfico y el vídeo.
                                        </label><br />
                                    <br />
                                    <li><strong>¿Qué aspectos éticos se ven afectados por la manipulación de imágenes?</strong></li><br>
                                        <label><input type="radio" name="pre2" class="space"  value = 5>El honor, la intimidad, la propia imagen.</label><br />
                                        <label><input type="radio" name="pre2" class="space"  value = 1>El engaño, la calumnia, el respeto.</label><br />
                                        <label><input type="radio" name="pre2" class="space"  value = 1>La tolerancia, la buena imagen, la vanidad.</label><br />
                                    <br>
                                </ul>
                            </p>
                        </div>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo3/unidad5/actividad2" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo4" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
