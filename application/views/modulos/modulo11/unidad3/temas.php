	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<br>
                <center>
                    <a href="<?php echo base_url();?>modulo11/unidad3" class="btn btn-success">Anterior</a>
                    <a href="<?php echo base_url();?>modulo11/unidad3/actividad1" class="btn btn-success">Siguiente</a>
                </center>
