    ...
    <div class="d-flex" id="wrapper">
                ...
                <ul class="list-group-item">
                    ...
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url(); ?>modulo11/unidad4/contenidos" class="list-group-item">Contenidos</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <br>
                <?php  $this->session->set_userdata('ruta','modulo11/unidad4/contenidos'); ?>
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>
                                Contenidos unidad 4. El nacimiento de medios alternativos
                            </h1>
                            <br>
                            <p class="m-b-10">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo11/unidad4/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Medios Alternativos
                                    </a><br><br>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo11/unidad4/actividad2" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 1: El nacimiento de medios alternativos
                                    </a><br><br>
                                </div>
                            </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo11/unidad4/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo11/unidad4/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
