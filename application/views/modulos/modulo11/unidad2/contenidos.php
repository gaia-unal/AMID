    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <br>
                <?php  $this->session->set_userdata('ruta','modulo11/unidad2/contenidos'); ?>
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>
                                Contenidos unidad 2. Dimensiones Socio-Culturales y Políticas de los Medios Globalizados
                            </h1>
                            <br>
                            <p class="m-b-10">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo11/unidad2/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Cultura
                                    </a><br><br>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo11/unidad2/actividad2" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 1: Dimensiones Socio-Culturales y Políticas de los Medios Globalizados
                                    </a><br><br>
                                </div>
                            </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo11/unidad2/inicio" class="btn btn_navegacion">Anterior</a>
