...
<body>
					...
					<div class="card-body">
						...
						<div id="parte3">
							<p class="card-text">
								...
								<div><a href="<?php echo base_url();?>public/assets/modulos/mod11/img/2-img1.png" target="_blank" rel="noopener noreferrer"><img
											src="<?php echo base_url();?>public/assets/modulos/mod11/img/2-img1.png" alt="" class="noti"></a></div>
								<br>
								<div><a href="<?php echo base_url();?>public/assets/modulos/mod11/img/2-img2.png" target="_blank" rel="noopener noreferrer"><img
											src="<?php echo base_url();?>public/assets/modulos/mod11/img/2-img2.png" alt="" class="noti"></a></div>
							</p>
						</div>
						<div id="parte4">
							<p class="card-text">
  ...
  <script src="<?php echo base_url();?>public/assets/modulos/mod11/js/script.js"></script>
</body>
