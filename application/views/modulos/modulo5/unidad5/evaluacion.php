        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m5u5a2'); 
            $this->session->set_userdata('ruta','modulo5/unidad5/evaluacion');
            $var = $this->session->userdata('objeto')['controller']->consulta();
            if(!$var){
                echo form_open('modulo6');
?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
        ...
        <center>
            <a href="<?php echo base_url();?>modulo5/unidad5/actividad1" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo6" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
