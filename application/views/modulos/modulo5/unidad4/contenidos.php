    ...
    <div class="d-flex" id="wrapper">
                ...
                <ul class="list-group-item">
                    ...
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url();?>modulo5/unidad4/actividad1" class="list-group-item">Actividades</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <div class="card mt-4">
                    <div class="card-body">
                        <?php $this->session->set_userdata('ruta','modulo5/unidad4/contenidos'); ?>
                        <div class="contenido ">
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo5/unidad4/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo5/unidad4/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
