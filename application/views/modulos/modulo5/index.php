        ...
        <div id="page-content-wrapper">
            ...
            <nav class="bread-style" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Módulo 5</li>
                </ol>
            </nav>
            <div class="contenedor">
                ...
                <div class="card mt-4 contenido">
                    <div class="card-body">
                        ...
                        <p>[1] UNAOC, UNESCO, "Módulo 5: Publicidad", en <em>Media Information Literacy for Teachers</em>, 2020.
                            <a href="http://unesco.mil-for-teachers.unaoc.org/modules/modulo-5-publicidad/?lang=es" target="_blank" rel="noopener noreferrer">
                            http://unesco.mil-for-teachers.unaoc.org/modules/modulo-5-publicidad/?lang=es</a>
                        </p>
                    </div>
                </div>
                <br>
            ...
            <center>
                <a href="<?php echo base_url();?>modulo4/unidad4/evaluacion" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo5/unidad1" class="btn btn_navegacion">Siguiente</a>
            </center>
            <br>
