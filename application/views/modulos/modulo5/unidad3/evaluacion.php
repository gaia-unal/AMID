        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m5u3a2'); 
                        $this->session->set_userdata('ruta','modulo5/unidad3/evaluacion');
                        $var = $this->session->userdata('objeto')['controller']->consulta();
                        if(!$var){
                            echo form_open('modulo5/unidad4/inicio');
?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo5/unidad3/actividad1" class="btn btn_navegacion">Anterior</a>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo5/unidad3/actividad1" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo5/unidad4" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
