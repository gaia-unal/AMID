        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            <div class="list-group list-group-flush">
                ...
                <ul class="list-group-item">
                    ...
                    <a href="<?php echo base_url();?>modulo5/unidad3" class="list-group-item">Unidad 4</a>
                    <a href="<?php echo base_url();?>modulo5/unidad4" class="list-group-item">Unidad 5</a>
                </ul>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php echo form_open('modulo5/unidad3/evaluacion');$this->session->set_userdata('idAct','m5u3a1'); $this->session->set_userdata('ruta','modulo5/unidad3/actividad1');?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido">
                            A partir de [1] se establece:
                            <blockquote>
                                <h4 class="subtitle">La publicidad y el auspicio – ubicación, mensajes y audiencia</h4>
                                <p class="card-text">
