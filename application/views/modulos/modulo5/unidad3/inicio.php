    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <br>
                <center>
                    <a href="<?php echo base_url();?>modulo5/unidad2/evaluacion" class="btn btn-success">Anterior</a>
                    <a href="<?php echo base_url();?>modulo5/unidad3/temas" class="btn btn-success">Siguiente</a>
          </center>
