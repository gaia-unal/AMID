                ...
                <ul class="list-group-item">
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url();?>modulo5/unidad1/actividad1" class="list-group-item">Contenidos</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <center>
                    ...
                    <?php echo form_open('modulo5/unidad1/evaluacion');$this->session->set_userdata('idAct','m5u1a1'); $this->session->set_userdata('ruta','modulo5/unidad1/actividad1');?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido">
                            [1] menciona que,
                            <blockquote>
                                <h4 class="subtitle">Examine y evalúe el objetivo y eficacia de las regulaciones en la industria de la publicidad</h4>
                                <p class="card-text">
