...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="contenido ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo10/unidad1/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 1: Audiencia
                                    </a><br><br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo10/unidad1/actividad2" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 2: Audiencia parte 2
                                    </a><br><br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                <a href="<?php echo base_url(); ?>modulo10/unidad1/actividad3" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 3: Audiencia parte 3
                                    </a><br><br>
                                </div>
                            </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo10/unidad1/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo10/unidad1/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
