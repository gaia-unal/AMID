        ...
        <div id="page-content-wrapper">
            ...
            <nav class="bread-style" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Módulo 8</li>
                </ol>
            </nav>
...
<br>
                            ...
                            <p>[1] UNAOC, UNESCO, "Módulo 8: Alfabetización informacional y destrezas bibliotecarias", en <em>Media Information Literacy for Teachers</em>, 2020.
                                <a href="http://unesco.mil-for-teachers.unaoc.org/modules/modulo-8-alfabetizacion-informacional-y-destrezas-bibliotecarias/?lang=es" target="_blank" rel="noopener noreferrer">
            ...
            <center>
                <a href="<?php echo base_url();?>modulo7/unidad2/evaluacion2" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url();?>modulo8/unidad1" class="btn btn_navegacion">Siguiente</a>
            </center>
            <br>
    ...
    <script src="<?php echo base_url();?>public/assets/modulos/mod8/js/u1info.js"></script>
