...
<body>
    ...
    <div class="d-flex" id="wrapper">
                ...
                <ul class="list-group-item">
                    ...
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url(); ?>modulo8/unidad1/contenidos" class="list-group-item">Contenidos</a>
        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>
                                Contenidos unidad 1. Conceptos y Aplicación de la Alfabetización Informacional
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo8/unidad1/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 1: Definición de información
                                    </a><br><br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo7/unidad2/actividad3" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 2: Retroalimentación conceptos y aplicaciones de la alfebetización informacionañ
                                    </a><br><br>
                                </div>
                            </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo8/unidad1/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo8/unidad1/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
