...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <ul class="list-group-item">
                    ...
                    <a href="<?php echo base_url();?>modulo8/unidad2" class="list-group-item inactive">Unidad 2</a>

                    <div class="btn-group dropright">


                        <a href="<?php echo base_url();?>modulo8/unidad3"  class="list-group-item inactive">Unidad 3</a>
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url();?>modulo8/unidad3/temas"
                                    class="list-group-item">Temas</a>
                                <a href="<?php echo base_url();?>modulo8/unidad3/actividad1"
        ...
        <div id="page-content-wrapper">
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo8/unidad3" class="btn btn_navegacion">Anterior</a>
