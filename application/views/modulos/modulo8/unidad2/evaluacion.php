        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <center>
                    ...
                    <?php 
                    $this->session->set_userdata('idAct','m8u2'); 
            $this->session->set_userdata('ruta','modulo8/unidad2/evaluacion');
            $var = $this->session->userdata('objeto')['controller']->consulta();
            if(!$var){
                echo form_open('modulo8/unidad3/inicio');
?>
                </center><br>
                <div class="card mt-4">
                    <div class="card-body">
        ...
        <center>
            <a href="<?php echo base_url();?>modulo8/unidad2/actividad2" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo8/unidad3" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
