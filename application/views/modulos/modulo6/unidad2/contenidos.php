...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="contenido ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo6/unidad2/actividad1" type="button" class="btn btn-info" style="width: 100%;">
                                        Actividad 1: Describir el uso de una o dos formas de nuevos medios para compartir conocimientos e información sobre temas de actualidad en la sociedad
                                    </a><br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo6/unidad1/actividad2" type="button" class="btn btn-info" style="width: 100%;">Uso de las Nuevas Tecnologías Mediáticas en la Sociedad – Comunicación de Masas y Digital</a><br><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo6/unidad2/inicio" class="btn btn_navegacion">Anterior</a>
                <a href="<?php echo base_url(); ?>modulo6/unidad2/actividad1" class="btn btn_navegacion">Siguiente</a>
            </center>
