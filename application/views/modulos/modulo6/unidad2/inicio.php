    ...
    <div class="d-flex" id="wrapper">
                ...
                <ul class="list-group-item">
                    ...
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url();?>modulo6/unidad2/contenidos" class="list-group-item">Contenidos</a>
                                <a href="<?php echo base_url();?>modulo6/unidad2/evaluaion"   class="list-group-item">Evaluación</a>
                            </ul>
                        </div>
                    </div>
        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <ul>
                                ...
                                <li>Interrelaciones entre cambios en la comunicación de masas como resultado de las nuevas tecnologías y cambios en las instituciones democráticas</li>
                            </ul>
                        </div>
                        <h4 class="subtitle">Bibliografía:</h4>
                        <p>[1] UNAOC, UNESCO, "Unidad 2: Uso de las Nuevas Tecnologías Mediáticas en la Sociedad – Comunicación de Masas y Digital", en 
                        <em>Media Information Literacy for Teachers</em>, 2020.
                            <a href="http://unesco.mil-for-teachers.unaoc.org/modules/modulo-6-medios-nuevos-y-tradicionales/unidad-2-uso-de-las-nuevas-tecnologias-mediaticas-en-la-sociedad-comunicacion-de-masas-y-digital/?lang=es" target="_blank" rel="noopener noreferrer">
                            http://unesco.mil-for-teachers.unaoc.org/modules/modulo-6-medios-nuevos-y-tradicionales/unidad-2-uso-de-las-nuevas-tecnologias-mediaticas-en-la-sociedad-comunicacion-de-masas-y-digital/?lang=es</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <center>
                ...
                <a href="<?php echo base_url();?>modulo6/unidad2/contenidos" class="btn btn_navegacion">Siguiente</a>
            </center>
            <?php echo form_close(); ?>
