        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    Aulas</h1>
                    <?php 
                    $this->session->set_userdata('idAct','m6u3'); 
            $this->session->set_userdata('ruta','modulo6/unidad3/evaluacion');
            $var = $this->session->userdata('objeto')['controller']->consulta();
            if(!$var){
                echo form_open('modulo7');
?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <br /><br />
                        <label><input type="radio" name="pre1" class="space" value = 5>Reutilizable, redistribuible, revisable, remixable, retenible.</label> <br/>
                        <label><input type="radio" name="pre1" class="space" value = 1>Repetible, universalidad, reversible.</label><br/>
                        <label><input type="radio" name="pre1" class="space" value = 1>Irrepetible, sostenible, responsable.</label><br/>
                        </p>
                        </div>
                    </div>
                </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo6/unidad3/actividad1" class="btn btn_navegacion">Anterior</a>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo6/unidad3/actividad1" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo7" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
