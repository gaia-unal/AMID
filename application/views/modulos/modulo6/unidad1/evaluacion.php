            ...
            <div class="contenedor">
                <center>
                    <h1 class="first_title"><br>Unidad 1: De Los Medios Tradicionales a las Nuevas Tecnologías
                        Mediáticas</h1>
                    <?php 
                    $this->session->set_userdata('idAct','m6u1a3'); 
            $this->session->set_userdata('ruta','modulo6/unidad1/evaluacion');
            $var = $this->session->userdata('objeto')['controller']->consulta();
            if(!$var){
                echo form_open('modulo6/unidad2/inicio');
?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
        ...
        <center>
            <a href="<?php echo base_url();?>modulo6/unidad1/actividad2" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo6/unidad2" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
