                            ...
                            <p class="card-text">
                                <ul>
                                    <li>Seleccione un texto mediático e informacional de su elección y aplique las preguntas
                                        ...
                                        <br><br>
                                    Piense sobre una actividad personal o económica que a usted le gustaría emprender y responda:<br><br>
                                    <li>¿Cuáles son mis necesidades de información?</li><br>
                                    ...
                                    <li>¿Cómo puedo presentar esta información en formatos que se puedan utilizar?</li><br>
                                        <textarea name="preg6" style="width: 100%;" rows="5" minlength="1" maxlength="150" onkeypress="return check(event)"
                                            placeholder="Escriba su respuesta aquí" spellcheck="true"></textarea>
                                    <li>¿Cómo puedo preservar, almacenar y reutilizar, grabar y archivar la información?</li><br>
                                    ...
                                    1. <input type="text" name="m1" id="m1" maxlength="40" onkeypress="return check(event)"><br><br>
                                    2. <input type="text" name="m2" id="m2" maxlength="40" onkeypress="return check(event)"><br><br>
                                    3. <input type="text" name="m3" id="m3" maxlength="40" onkeypress="return check(event)"><br><br>
                                    4. <input type="text" name="m4" id="m4" maxlength="40" onkeypress="return check(event)"><br><br>
                                    5. <input type="text" name="m5" id="m5" maxlength="40" onkeypress="return check(event)"><br><br>
