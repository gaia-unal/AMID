...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                        ...
                        <p class="card-text">
                            A continuación se exponen enfoques pedagógicos para enseñar AMI: <br>
                                ...
                                <div id="parte1" style="display:block;">
                                    ...
                                    El aprendizaje de enseñanza reflexiva es un enfoque centrado en el estudiante donde
                                    la
                                    ...
                                    asociadas con el aprendizaje inquisitivo, resolución de problemas y toma de
                                    decisiones,
                                    ...
                                    localización, organización y análisis de la evidencia; interpretación y resolución
                                    del
                                    tema; tomar acción y reconsiderar las consecuencias y los resultados de cada fase.
                                    Este
                                    ...
                                    reflexiva en el enfoque de AMI incluyen: explorar las representaciones de género y
                                    raza
                                    a través de un análisis de los medios; explorar la privacidad y los medios a través
                                    de
                                ...
                                <div id="parte2" style="display:none;">
                                    ...
                                    instrucción que desarrolla simultáneamente las bases y habilidades de un
                                    conocimiento
                                    ...
                                    basado en problemas en AMI sería el diseño de una campaña social de mercadeo para
                                    una
                                ...
                                <div id="parte3" style="display:none;">
                                    ...
                                    La interrogación científica se refiere a una variedad de técnicas que los
                                    científicos
                                    utilizan para explorar el mundo natural y proponen explicaciones basadas en las
                                    evidencias que encuentran. A menudo, el proceso de indagación se expresa como un
                                    grupo
                                    simplificado de pasos que se denomina el ciclo de la interrogación, el cual
                                    comprende
                                    ...
                                    experimental; utilizando herramientas para recolectar, analizar e interpretar los
                                    datos;
                                    proponer explicaciones y comunicar los resultados. Este método también se puede
                                    incorporar dentro de la enseñanza de AMI. Ejemplos de esta interrogación científica
                                    en
                                ...
                                <div id="parte4" style="display:none;">
                                    ...
                                    El método de estudio de caso conlleva un examen profundo de una sola instancia o
                                    evento.
                                    ...
                                    enseñanza de AMI si los estudiantes están expuestos diariamente a las distintas
                                    formas
                                    de mensajes. Esto requiere una forma sistemática de observar los eventos, recolectar
                                    información, analizar la información e informar acerca de los resultados, que a la
                                    vez
                                    brinda apoyo al aprendizaje basado en la indagación entre los alumnos. De esta forma
                                    los
                                    ...
                                    generación y validación de hipótesis. Por ejemplo, los estudiantes podrían llevar a
                                    cabo
                                ...
                                <div id="parte5" style="display:none;">
                                    ...
                                    El aprendizaje cooperativo tiene que ver con el enfoque de enseñanza que coloca a
                                    los
                                    estudiantes a trabajar juntos para alcanzar metas compartidas. El aprendizaje
                                    cooperativo puede ir desde el simple trabajo en parejas hacia un modo más complejo
                                    como
                                    el aprendizaje de un proyecto, aprendizaje jigsaw (en grupos escalonados), preguntas
                                    guiadas por los pares y enseñanza reciproca, todo lo cual busca producir ganancias
                                    en el
                                    aprendizaje como son el desarrollo de entendimientos conceptuales y el pensamiento
                                    de
                                    ...
                                    un
                                    método apropiado en la enseñanza y aprendizaje de AMI ya que requiere que se
                                    compartan
                                    las ideas de uno a otro. Un ejemplo de este aprendizaje cooperativo en AMI podría
                                    ser
                                ...
                                <div id="parte6" style="display:none;">
                                    ...
                                    convenciones de los varios géneros de medios. Con este tipo de análisis semiótico,
                                    se
                                    puede incrementar el entendimiento de los conceptos claves. Por ejemplo, los
                                    estudiantes
                                    aprenden a identificar cómo los códigos lingüísticos y las convenciones se utilizan
                                    para
                                    crear tipos especiales de representaciones que atraen a ciertas audiencias. Se
                                    enseña a
                                    ...
                                    desarrolla en un contexto relevante, en lugar de ser sólo un ejercicio académico por
                                    sí
                                    mismo. Ejemplo: Se puede solicitar a los estudiantes que elijan una pieza de un
                                    texto
                                    mediático que les interesa. Esto puede ser una noticia, un video de YouTube, o video
                                    clip de una noticia de una fuente en línea. Se distribuye a los estudiantes en
                                    grupos y
                                ...
                                <div id="parte7" style="display:none;">
                                    ...
                                    Se enseña a los estudiantes a realizar un análisis contextual básico, especialmente
                                    en
                                    ...
                                    contextual y de la pedagogía en esta área incluyen ayudar a los estudiantes a
                                    clasificar
                                    sistemas por películas, televisión y juegos de video que operan en su país, o como
                                    la
                                ...
                                <div id="parte8" style="display:none;">
                                    <h4>Traducciones</h4>
                                    Con este enfoque los estudiantes pueden tomar un artículo que se presenta en un
                                    medio y
                                    ...
                                    <ul>
                                        ...
                                        <li>Ppueden recolectar una variedad de material visual existente relacionado con
                                            la
                                ...
                                <div id="parte9" style="display:none;">
                                    <h4>Simulaciones</h4>
                                    A menudo se utiliza la simulación como una estrategia en una película y unidades de
                                    un
                                    Curriculum sobre medios. Como ya se ha mencionado, los tutores usan la simulación
                                    para
                                    demostrar a los estudiantes cómo se “ve” el aprendizaje de los medios. Es decir, el
                                    tutor asume el papel de un profesor de clase y los profesores actúan como
                                    estudiantes de
                                    escuela/colegio, por lo menos cuando llevan a cabo las actividades. Esta estrategia
                                    se
                                    ...
                                    <ul>
                                        <li>Los estudiantes asumen el papel de un equipo de producción de un documental
                                            para
                                        ...
                                        <li>Los estudiantes toman el papel de periodistas de radio/Internet que están
                                            investigando la enseñanza de medios y tienen que entrevistar a un profesor
                                            en el
                                            ejercicio de profesor de medios y luego editar un podcast de la entrevista
                                        </li>
                                        <li>Los estudiantes asumen el rol de un equipo de mercadeo de una universidad
                                            que
                                ...
                                <div id="parte10" style="display:none;">
                                    <h4>Producción</h4>
                                    Este enfoque implica aprender haciendo que es un aspecto importante de la
                                    adquisición de
                                    ...
                                    contenidos de información ofrece a los estudiantes la oportunidad de una inmersión
                                    en el
                                    aprendizaje a través de explorar y hacer. Por medio de la producción de textos
                                    mediáticos (por ejemplo audio, video e impresos) los estudiantes son capaces de
                                    explorar
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo1/unidad4/temas" class="btn btn_navegacion">Anterior</a>
