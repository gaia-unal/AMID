...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                <strong>Tema:</strong> La Alfabetización mediática e informacional <br><strong>Propósito
                                    de la actividad:</strong> Identificar los principales resultados/elementos de
                                aprendizaje de la alfabetización mediática e informacional.
                                <br><br>
                                <i class="fas fa-question-circle"></i>
                                Arrastre cada uno de los conceptos que se encuentran en la parte inferior, hasta el cuadrado de la frase que se relacione con él.
                            </p>
                            <center>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo1/unidad1/actividad4" class="btn btn_navegacion">Anterior</a>
