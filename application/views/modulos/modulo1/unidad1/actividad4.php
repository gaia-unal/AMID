    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <br><?php $this->session->set_userdata('ruta','modulo1/unidad1/actividad4');?>
                <div class="card mt-4">
                    <div class="card-body">
                    <h4 class="subtitle">Los múltiples papeles de los medios</h4><br>
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                <p>
                                [1] Santana Cabrera, E., "la Alfabetización Mediática e Informacional en <em>INED21</em>, Mar. 5. 2018. 
                                <a target="_blank" rel="noopener noreferrer" href="https://ined21.com/la-alfabetizacion-mediatica-e-informacional/"> 
                                https://ined21.com/la-alfabetizacion-mediatica-e-informacional/</a>
                                </p>
                            </p>
                        </div>
                    </div>
