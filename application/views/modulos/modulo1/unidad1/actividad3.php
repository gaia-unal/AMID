    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                $this->session->set_userdata('ruta','modulo1/unidad1/actividad3');
                ?>
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                a continuación una lista de los medios presentes en la vida de los estudiantes y
                                profesores en la actualidad. <br>
                                <center>
                                    <label class="space" for="m1">1.</label><input type="text" name="medios1" id="m1"
                                        autofocus minlength="1" maxlength="50"
                                        onkeypress="return check(event)"><br><br>
                                    <label class="space" for="m2">2.</label><input type="text" name="medios2" id="m2"
                                        minlength="1" maxlength="50" onkeypress="return check(event)"><br><br>
                                    <label class="space" for="m3">3.</label><input type="text" name="medios3" id="m3"
                                        minlength="1" maxlength="50" onkeypress="return check(event)"><br><br>
                                    <label class="space" for="m4">4.</label><input type="text" name="medios4" id="m4"
                                        minlength="1" maxlength="50" onkeypress="return check(event)"><br><br>
                                    <label class="space" for="m5">5.</label><input type="text" name="medios5" id="m5"
                                        minlength="1" maxlength="50" onkeypress="return check(event)"><br><br>
                                </center>
                                ...
                                su municipio, que tiene como función informar a la audiencia sobre actividades culturales,
