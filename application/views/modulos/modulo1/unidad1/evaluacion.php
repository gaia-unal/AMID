  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <div><a
                  ...
                  target="_blank"><img class="noticia" src="<?php echo base_url();?>public/assets/modulos/mod1/img/noticia.png" alt="noticia"></a></div><br>
        ...
        <center>
          <a href="<?php echo base_url();?>modulo1/unidad1/actividad10" class="btn btn-success">Anterior</a>
