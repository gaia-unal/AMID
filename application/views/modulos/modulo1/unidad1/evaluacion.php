        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <ul class="list-group-item">
                    ...
                    <a href="#" onclick="inactivo(1)" class="list-group-item list-group-item-action bg-light inactive"
                        id="unid-sgte">Unidad 2</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                Para ver el artículo completo, presione sobre la imágen <br><br>

                            <div><a href="https://www.elespectador.com/noticias/el-mundo/cucuta-un-oasis-para-los-venezolanos-antes-de-las-presidenciales-en-su-pais-articulo-789059"
                                    target="_blank"><img class="noticia"
                                        src="<?php echo base_url();?>public/assets/modulos/mod1/img/noticia.png"
                                        alt="noticia"></a></div><br>
                            ...
                            <center>
                                <em>
                                    "Los cruces fronterizos del departamento colombiano de Norte de Santander, principal
                                    conexión con
                                    Venezuela, son testigos de la odisea de las cerca de 50.000 personas que entran y
                                    salen de ese país a
                                    diario por estas fechas, unos 15.000 más de lo habitual. <br>
                                    Lo hacen para abastecerse de alimentos, medicinas y artículos de higiene para los
                                    días venideros
                                    porque, según dicen, no saben lo que pueda pasar después de las elecciones
