    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                ...
                <div class="card mt-4"><br>
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                <li>Entender y describir las funciones de los medios y otros proveedores de información
                                    a medida que estos
                                    se relacionen con el acceso a la información y conocimiento, auto-expresión y
                                    participación en los
                                    procesos democráticos.</li>
                                <li>Identificar las condiciones necesarias para que los medios y los otros proveedores
                                    de información
            ...
            <center>
                ...
                <a href="<?php echo base_url();?>modulo1/unidad2/temas" class="btn btn_navegacion">Siguiente</a>
            </center>
