  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class="card mt-4">
          <div class="card-body">
            ...
            <ul>
              ...
              <li>Qué es lo que los ciudadanos deberían esperar de los medios y los otros proveedores de información
                como bibliotecas, archivos y el Internet</li>
              <li>AMI y su importancia en la democracia y el buen gobierno</li>
              <li>Libertad de expresión, independencia editorial de los medios, pluralidad y diversidad de los medios y
        ...
        <br>
        <center>
          <a href="<?php echo base_url();?>modulo1/unidad2" class="btn btn-success">Anterior</a>
          <a href="<?php echo base_url();?>modulo1/unidad2/actividad1" class="btn btn-success">Siguiente</a>
          </center>
