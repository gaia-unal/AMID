                    ...
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                que
                                los ciudadanos deberían esperar de ellos. <br> Relacione las columnas colocando el
                                número
                                que corresponde en el paréntesis con las características que describen el tipo de
                                función de
                            ...
                            <div class="row" id="table_container">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input class="respuesta" type="number" name="resp1" id="resp1" min="1"
                                                    max="8">
                                                &nbsp; Brindar un conocimiento oportuno de los temas importantes y
                                                tendencias.</td>
                                        </tr>
                                        <tr>
                                            <td>2) Verdad</td>
                                            <td><input class="respuesta" type="number" name="resp2" id="resp2" min="1"
                                                    max="8"> &nbsp;Dotar a los
                                                ciudadanos de la información necesaria para que puedan tomar parte en
                                                los
                                                asuntos públicos.
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="respuesta" type="number" name="resp6" id="resp6" min="1"
                                                    max="8"> &nbsp; Ofrecer
                                                varios canales para la interacción del público y amplia representación
                                                de
                                ...
                                <center>
                            <a class="btn btn_navegacion_validacion" onclick="termino()">Validar</a></center>
                            </div>
