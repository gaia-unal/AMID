                                ...
                                <div class="contenido" >
                                    ...
                                    <p class="card-text" id="just-left">
                                        ...
                                        Considere la siguiente frase: <em>"Los lideres están en la obligación de
                                            mantener la
                                            neutralidad de la información, manteniendo una mentalidad abierta con el fin
                                            de que el
                                            ciudadano de bien tome buenas decisiones evitando las conveniencias
                                            particulares"</em>
                                        <br> <br>
                                        <strong>
                                            ¿Cuál de las siguientes afirmaciones apoya en mejor medida lo expresado por
                                            la anterior frase? <br> <br>
                                        </strong>
                                        <label><input type="radio" name="opc1" id="op1" onclick="incorrecto()" value="1"
                                                required>
                                            La información debe ser un medio a través del cual los ciudadanos deben ser
                                            influidos a actuar de una mejor manera.
                                        </label>
                                        <br>
                                        <label><input type="radio" name="opc1" id="op2" onclick="incorrecto()" value="1"
                                            ...
                                            ser el parámetro para tomar decisiones según la cultura y sociedad en que
                                            viven.
                                        </label>
                                        <br>
                                        ...
                                        <label><input type="radio" name="opc1" id="op5" onclick="correcto()" value="5"
                                                required>
                                            Cuando lidero un grupo procuro poner en perspectiva las diferentes
                                            posiciones y compartir en diferentes medios los análisis de forma general
                                            sin posturas apasionadas.
                                        </label>
                                        <br><br>
