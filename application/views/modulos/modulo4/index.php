  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <br>
        <center>
            <a href="<?php echo base_url();?>modulo3/unidad5/evaluacion" class="btn btn-success">Anterior</a>
            <a href="<?php echo base_url();?>modulo4/unidad1" class="btn btn-success">Siguiente</a>
        </center>
