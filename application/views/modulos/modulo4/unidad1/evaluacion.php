...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m4u1a8'); 
                        $this->session->set_userdata('ruta','modulo4/unidad1/evaluacion');
                        $var = $this->session->userdata('objeto')['controller']->consulta();
                        if(!$var){
                            echo form_open('modulo4/unidad2/inicio');
                        ?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <ol>
                                ...
                                <textarea name="preg1" style="width: 95%;" rows="5" minlength="1" maxlength="200" onkeypress="return check(event)"
                                    ...
                                    <br> <li>¿Qué símbolos puede encontrar en la comunidad?</li><br>
                                <textarea name="preg2" style="width: 95%;" rows="5" minlength="1" maxlength="200" onkeypress="return check(event)"
                                    ...
                                    <br> <li>¿Qué elementos componen un collage?</li><br>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo4/unidad1/actividad7" class="btn btn_navegacion">Anterior</a>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo4/unidad1/actividad7" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo4/unidad2" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
