    ...
    <div class="container">
        <div class="row">
                ...
                <a href="<?php echo base_url();?>modulo1" class="list-group-item">Módulo 1</a>
                    ...
                    <ul class="list-group-item">
                        ...
                        <ul class="list-group-item">
                            ...
                            <a href="<?php echo base_url();?>modulo4/unidad1/actividad1" class="list-group-item">Actividad</a>
            ...
            <div class="col-lg-9">
                ...
                <br>
                <center>
                    <a href="<?php echo base_url();?>modulo4/unidad1" class="btn btn-success">Anterior</a>
                    <a href="<?php echo base_url();?>modulo4/unidad1/actividad1" class="btn btn-success">Siguiente</a>
                </center>
