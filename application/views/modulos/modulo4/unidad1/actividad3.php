                    ...
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            ...
                            <ul>
                                ...
                                <li>El mensaje transmitido por la televisión no puede ser releído, a no ser que
                                    previamente
                                    el usuario haya decidido su grabación, por tanto, su lenguaje se caracterizará por:
                                    <ul>
                                        <li>Emplear frases sencillas con un léxico común, para llegar a todo el mundo
                                        </li>
                                        <li>Utilizar repeticiones</li>
                                        <li>Evitar términos ofensivos o discriminatorios.</li>
                                        <li>Mantener la atención del televidente mediante el empleo de recursos orales.
                                        </li>
                                        <li>Cuidar la vocalización y el tono adecuado.</li>
                                        <li>Enriquecer el contenido con la utilización del sonido ambiente y la música.
                                        </li>
                                        <li>Utilizar como tiempo verbal preferente el presente, y para dirigirse a
                                            hechos
                                        ...
                                        <li>Falsean la realidad como consecuencia de la tendencia a la superficialidad
                                            que
                                            tiene el medio televisivo.</li>
                                    </ul>
                                </li>
                                <li>Básicamente, la televisión consiste en la transmisión de sonido e imágenes en
                                    movimiento
                                    y utiliza códigos muy parecidos al cine. Su transmisión está gestionada por empresas
                                    y
                                    necesita ser rentable, por lo que uno de los objetivos de los programadores es
                                    captar y
                                    mantener las audiencias.</li>
                            </ul>
                            Este lenguaje contiene unos elementos que lo caracterizan, los cuales son:
                            <ul>
                                <li>El <strong>estudio</strong> es el espacio donde toda cadena de televisión, organiza
                                    y
                                    ejecuta los elementos que componen su producción. En los estudios se siguen paso a
                                    paso
                                    las escenas de lo programas y series, se graba todo lo que emiten las cámaras y se
                                    edita
                                ...
                                <li>El <strong>guión</strong> es el texto escrito que se presenta todo lo que conforma
                                    una
                                    obra audiovisual En la televisión, la coexistencia de tan variada cantidad de
                                    formatos y
                            ...
                            <ul>
                                <li><strong>Documental:</strong> es un género que intenta describir aspectos de
                                    larealidad y
                                    el entorno. Sus objetivos principales son enseñar, informar,describir o denunciar
                                </li>
                                <li><strong>Entretenimiento:</strong> los programas de entretenimiento basan
                                    suscontenidos
                                ...
                                <li><strong>Ficción:</strong> incluye géneros como series, miniseries, telenovela,
                                    ...
                                    <ul>
                                        ...
                                        <li>Están realizados en Estudio, lo que conlleva un absoluto control de los
                                            efectos,
