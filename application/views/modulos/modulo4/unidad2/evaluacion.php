        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m4u2'); 
                        $this->session->set_userdata('ruta','modulo4/unidad2/evaluacion');
                        $var = $this->session->userdata('objeto')['controller']->consulta();
                        if(!$var){
                            echo form_open('modulo4/unidad3/inicio');
?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                <br /><br />
                                <label><input type="radio" name="pre1" class="space"  value= 1>Cobertura básica y cobertura compleja.</label> <br />
                                <label><input type="radio" name="pre1" class="space"  value= 5>Cobertura adquirida y cobertura ganada.</label><br />
                                <label><input type="radio" name="pre1" class="space"  value= 1>Cobertura parcial y cobertura imparcial.</label><br />
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo4/unidad2/actividad3" class="btn btn_navegacion">Anterior</a>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo4/unidad2/actividad3" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo4/unidad3" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
