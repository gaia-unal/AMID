...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php 
                        $this->session->set_userdata('idAct','m4u3a5'); 
                        $this->session->set_userdata('ruta','modulo4/unidad3/evaluacion');
                        $var = $this->session->userdata('objeto')['controller']->consulta();
                        if(!$var){
                            echo form_open('modulo4/unidad4/inicio');
                        ?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <div class="contenido">
                            <p class="card-text">
                                ...
                                <center><a class="btn btn-outline-success" onclick="termino()">Validar</a></center>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <center>
            <a href="<?php echo base_url();?>modulo4/unidad3/actividad4" class="btn btn_navegacion">Anterior</a>
            <a href="<?php echo base_url();?>modulo4/unidad4" class="btn btn_navegacion">Siguiente</a>
        </center>
            <?php } ?>
