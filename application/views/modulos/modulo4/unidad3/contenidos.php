    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="<?php echo base_url(); ?>modulo2" class="list-group-item list-group-item-action bg-light"><i class="dropdown-menu"></i>Módulo 2<span class="arrow"></span></a>
                ...
                <ul class="list-group-item">
                    ...
                    <div class="btn-group dropright">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-group-item">
                                <a href="<?php echo base_url(); ?>modulo4/unidad3/contenidos" class="list-group-item">Contenidos</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="contenido ">
                            <h1 class="first_title"><br>Contenidos unidad 3. Géneros de películas y de cuentos</h1>
                            <br>
                            <p class="m-b-10">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo4/unidad3/actividad1" type="button" class="btn btn-info" style="width: 100%;">Peliculas</a> <br><br>
                                </div>
                                <div class="col-6">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo4/unidad3/actividad2" type="button" class="btn btn-info" style="width: 100%;">Storyboard</a> <br><br>
                                </div>
                                <div class="col-6">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo4/unidad3/actividad3" type="button" class="btn btn-info" style="width: 100%;">Carteles</a> <br><br>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo base_url(); ?>modulo4/unidad3/actividad4" type="button" class="btn btn-info" style="width: 100%;">Actividad 1: Géneros de películas y de cuentos</a><br><br>
                                </div>
                            </div>
            ...
            <br>
            <center>
                <a href="<?php echo base_url(); ?>modulo4/unidad3/inicio" class="btn btn_navegacion">Anterior</a>
