        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php echo form_open('modulo4/unidad3/evaluacion');$this->session->set_userdata('idAct','m4u3a4'); $this->session->set_userdata('ruta','modulo4/unidad3/actividad4');?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
                        <h4 class="subtitle">Reflexión</h4>
                        <div class="contenido">
                            <p class="card-text">
                                <ul>
                                    ...
                                    <br> <li>¿Qué usos le puede dar a un storyboard en el aula de clase?</li><br>
                                    ...
                                    <br> <li>¿Qué impresión de la película se transmite a través de los carteles?</li><br>
                                    <textarea name="preg3" style="width: 90%;" rows="6" minlength="1" maxlength="500" onkeypress="return check(event)"
                                        placeholder="Escriba su respuesta aquí" spellcheck="true"></textarea><br>
                                    <br><li>¿Qué códigos técnicos y simbólicos se utilizan? ¿Cuál es el propósito?</li><br>
                                    <textarea name="preg4" style="width: 90%;" rows="6" minlength="1" maxlength="500" onkeypress="return check(event)"
                                        placeholder="Escriba su respuesta aquí" spellcheck="true"></textarea><br>
                                    <br> <li>Basándose en los carteles, ¿puede identificar cuál es la audiencia seleccionada para
                                        cada película?</li><br>
                                    <textarea name="preg5" style="width: 90%;" rows="6" minlength="1" maxlength="500" onkeypress="return check(event)"
                                        placeholder="Escriba su respuesta aquí" spellcheck="true"></textarea><br>
                                    <br> <li>A través de los carteles, ¿qué información se transmite sobre cada película?</li><br>
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo4/unidad3/actividad3" class="btn btn_navegacion">Anterior</a>
