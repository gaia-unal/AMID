                ...
                <a href="<?php echo base_url();?>modulo1" class="list-group-item">Módulo 1</a>
                    ...
                    <a href="<?php echo base_url();?>modulo4/unidad1" class="list-group-item">Unidad 1</a>
                        ...
                        <ul class="list-group-item">
                            ...
                            <a href="<?php echo base_url();?>modulo4/unidad4/actividad1" class="list-group-item">Actividad</a>
            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <h4>Temas claves</h4>
                        <ul>
                            <li>Explorando y analizando los planos de cámara y los ángulos en los textos mediáticos</li>
                            <li>Desarrollando una lista de tomas para el trabajo con las cámaras</li>
                        </ul>
                    </div>
                </div>
                <!-- /.card -->
                <br>
                <center>
                    <a href="<?php echo base_url();?>modulo4/unidad3/evaluacion" class="btn btn-success">Anterior</a>
                    <a href="<?php echo base_url();?>modulo4/unidad4/actividad1" class="btn btn-success">Siguiente</a>
                </center>
