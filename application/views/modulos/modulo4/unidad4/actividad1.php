        ...
        <div id="page-content-wrapper">
            ...
            <div class="contenedor">
                <center>
                    ...
                    <?php echo form_open('modulo4/unidad4/evaluacion');$this->session->set_userdata('idAct','m4u4a1'); $this->session->set_userdata('ruta','modulo4/unidad4/actividad1');?>
                </center>
                <div class="card mt-4">
                    <div class="card-body">
            ...
            <br>
            <center>
                <a href="<?php echo base_url();?>modulo4/unidad4/contenidos" class="btn btn_navegacion">Anterior</a>
