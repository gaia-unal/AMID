...
<body id="body">
  ...
  <div id="recuperar" class="modalDialog">
    <div class="contentmodal">
      ...
      <div class="modal-body">
        <center>
            <p>Seleccione la forma en la que quiere restablecer su contraseña:</p>
          </center>
        <div class="row">
          
          <div class="col-6">
            <input type="button" class="btn btn-info space" onclick="mostrarPregunta()" value="Pregunta de seguridad">
          </div>
          <div class="col-6">
            <input type="button" class="btn btn-info space" onclick="window.location.href='<?php echo base_url('inicio/forgotPassword'); ?>'" value="Enviar un correo">
          </div>
          <br><br>
        </div>

        <div class="preguntaSeguridad" id="preguntaSeguridad">
          ...
          <div class="input-group center  mb-10">
            ...
            <input type="password" name="pass1_r" id="pass1_r" class="form-control mb-10 space_between" pattern="(?=.*\d)(?=.*[A-Za-z])(?=.*[@#$%]).{8,}" title="Debe contener al menos un número, una letra, uno de estos símbolos '@', '#', '$' o '%' y al menos 8 caracteres" placeholder="Nueva contraseña" required>
    ...
    <div class="contentmodal">
      ...
      <div class="modal-body">
        ...
        <div class="input-group center  mb-10">
          ...
          <input type="password" name="pass1" id="pass1" class="form-control mb-10 space_between" pattern="(?=.*\d)(?=.*[A-Za-z])(?=.*[@#$%]).{8,}" title="Debe contener al menos un número, una letra, uno de estos símbolos '@', '#', '$' o '%' y al menos 8 caracteres" placeholder="Contraseña" required>
  ...
  <script>
    function mostrarPregunta() {
      document.getElementById('preguntaSeguridad').style.visibility = 'visible';
    }
  </script>
  <style>
    .preguntaSeguridad {
